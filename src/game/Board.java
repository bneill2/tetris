...
import leaderboard.ScoreManager;
...
public class Board extends JPanel {
    ...
    private void setScore() {
    	String name = JOptionPane.showInputDialog(this,
                "Add your name to the leaderboard", null);
    	scoreManager.addScore(name, numLinesRemoved);
    	
    	System.out.println(scoreManager.getHighscoreString());
